...
***** Functions
      ...
      (defun seconf/run-term ()
        ...
        (rename-buffer
         (read-string "Rename term buffer: " nil nil "term") t))
...
***** Customize
      ...
      (customize-set-variable 'multi-term-dedicated-window-height 9)
...
***** Functions
      ...
      (defun seconf-set-dash-docset (docset)
...
***** Binds
      ...
      ;; seconf-docs-map
      (define-key seconf-docs-map (kbd "u") 'dash-docs-update-docset)
      ;; (define-key seconf-docs-map (kbd "i") 'dash-docs-async-install-docset)
      (define-key seconf-docs-map (kbd "i") 'dash-docs-install-docset)
      (define-key seconf-docs-map (kbd "l") 'dash-docs-search-docs)
      (define-key seconf-docs-map (kbd "a") 'dash-docs-activate-docset)
      (define-key seconf-docs-map (kbd "d") 'dash-docs-deactivate-docset)
...
***** Binds
      ...
      (define-key seconf-pm-map (kbd "<f5>") 'projectile-compile-project)
...
***** Hooks
      ...
      (add-hook 'emacs-lisp-mode-hook
                (lambda ()
                  ...
                  (seconf-set-dash-docset "Emacs Lisp")))
...
***** Hooks
      ...
      (add-hook 'python-mode-hook
                (lambda ()
                  ...
                  ;; set dash docsets
                  (seconf-set-dash-docset '"Python 3")))
...
** Cleanup
   ...
   if needed, exotic commands can be called with
   =execute-extended-command= know as =M-x= or even better the
   =minibuffer console=.
